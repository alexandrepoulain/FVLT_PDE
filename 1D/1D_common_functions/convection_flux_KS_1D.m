function [fluxm_h] = convection_flux_KS_1D(u,v,nbx,h,dt,deg_1,deg_2,lim,BC)
%CONVECTION_FLUX_KS_1D This function computes the convective fluxes at the
% interface of the cells for the Keller-Segel model
% Inputs:
% - u: array of scalars
% - v: velocity (real or array)
% - nbx: number of points (corresponding to the number of cells)
% - h: constant grid size.
% - deg_1,deg_2: decomposition of the chemosensitivity 'standard' or 'volume-filling'
...
% first order upwind
fmip12 = upwind_flux_degenerate_mobility(u,v,nbx,h,dt,deg_1,deg_2,BC);
